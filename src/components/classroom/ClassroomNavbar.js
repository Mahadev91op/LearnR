      ...
      <div className="hidden md:flex h-screen w-64 bg-[#0a0a0a] border-r border-white/10 flex-col fixed left-0 top-0 z-[110]">
        ...
        <div className="p-6 border-b border-white/5">
           ...
           <div>
               ...
               <span className="text-[10px] text-yellow-400 font-bold tracking-wide bg-yellow-400/10 px-2 py-0.5 rounded mt-2 inline-block border border-yellow-400/20">
                 INSTRUCTOR MODE
               </span>
           </div>
        </div>
